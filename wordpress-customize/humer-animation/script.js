...
let svgBody = jQuery("#js-svg");
let svgMoveParts = jQuery(".svg-move-parts");
let svgMouth5 = jQuery(".svg-move5");
let svgMouth7 = jQuery(".svg-move7");
let SPEED = 210; //動く速さ
let EASING = mina.easein; //snap.svgに用意されているeasing
let direction = true; //正の向き
let animationCount = 0;
let windowSize = jQuery(window).width(); //ウィンドウサイズ
...
function humerAnimation1() {
    if (isAnimation && animationCount <= 2) {
...
function humerAnimation2() {
    ...
    $svgMouth6.animate({ d: "M329.75652,173.71985a28.47841,28.47841,0,0,1,26.68481-2.51572q2.77778,29.46448,5.55553,58.929a22.336,22.336,0,0,1-26.68481,2.51569Q332.53429,203.18431,329.75652,173.71985Z" }, SPEED, EASING);//本来はここにstarAnimation
...
function bodyAnimation() {
    svgBody.toggleClass("body-animation");
}
